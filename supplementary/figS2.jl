...
# ╔═╡ 69389a6e-ee11-11ef-0f82-57d5ae7a3383
begin
	using DifferentialEquations, CairoMakie, FileIO, IntervalRootFinding, LinearAlgebra, ForwardDiff, MakieExtra
	using ColorSchemes: colorschemes
end

# ╔═╡ d0d4bf1c-6e53-4e39-b5c3-bbda40bb19b7
function RELU(x)
	return max(0, x) 
end

# ╔═╡ 39e81a92-e356-4533-9e20-dfff16a742b7
...
# ╔═╡ d6570892-bd5a-4b62-a61d-dc1b798f5077
baseP = (
	g = 10.0,
	r = 0.2,
	T_star = 100.0,
...
# ╔═╡ 97f82858-7693-42c9-bf30-83752e79e66d
baseU0 = (
	T = 0.0,
	I = 1.0
...
# ╔═╡ 4fa4fd80-fb2c-4e29-ab31-af50cc98c10e
...
# ╔═╡ 3733a103-3ed1-4202-8541-dcfb362399a1
...
# ╔═╡ 9fdf9310-f3a2-49bf-a23b-a92cc8c6e697
...
# ╔═╡ 317868bf-a95e-49e4-88d1-5e4fe4114b95
function diffEquationReduced(du, u, p, t)
	du[1], du[2] = fReduced(u[1], u[2], p)
end

# ╔═╡ bbb906eb-7bc8-4a30-bc5b-a091c4bfb013
...
# ╔═╡ 45a5fc87-9fef-45d4-a47b-0c69cb6aafe1
...
# ╔═╡ 87daa732-200a-4316-98a2-fac6de7c8bbd
...
# ╔═╡ c8a97c17-ac92-4033-a220-76222ee4ddbf
function makeStreamPlotReduced(fig, params, (minX, maxX, minY, maxY); show_bassin=false, basinColor = [:aquamarine])
	...
	ll = 5
	for (i, rVal) in enumerate(10 .^LinRange(-1, 1, ll))
		tt = (0:0.001:50)
		sol = integrateSystemReduced([g, rVal, T_star, T_star_reg, alpha, beta, gamma, delta1, delta2, kappa, mu], [0, 10^0], tt)
		x = log10.(abs.(sol[1, :]))
	    y = log10.(abs.(sol[2, :]))
	
	    obj = lines!(rightPannelAx1, x, y; color = i, colorrange = (1, ll), colormap=:roma, linewidth=4, alpha = 0.8)
	end
    Colorbar(fig[1, 2], limits = (0.1, 10^1), scale = log10, label="Growth rate", colormap = :roma)
end

# ╔═╡ f8f5796b-d98e-4165-b12a-13625de7d633
let 
	...
	makeStreamPlotReduced(fig[1, 1], [g, 0.2, T_star, T_star_reg, alpha, beta, gamma, delta1, delta2, kappa, mu], plotBounds, show_bassin=true, basinColor = [:grey60])

	save("makieExports/figS2.png", fig)
...
manifest_format = "2.0"
project_hash = "2a7b61c4db0afb41a6d1c51419d6225687838fe6"
